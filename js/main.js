    ...
    for (const el of arr) {
      ...
      data-aos-easing="ease-in-sine">
        <img src="././assets/img/${img}" alt="${nombre}"/>
          ...
          <button class="btn btn-primary button-instrument-tienda logo-button-shopp" id="button-instrument-tienda" id="${id}" onclick="btnCarrito(${id})">Agregar al carrito <img src="./../assets/img/shopping.svg" alt="logo-shopping"></button>
          </div>
      </div>`;
