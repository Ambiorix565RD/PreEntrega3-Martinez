    ...
    for (const el of arr) {
      ...
      data-aos-easing="ease-in-sine">
        <img src="././assets/img/${img}" alt="${nombre}"/>
          ...
          <a class="btn btn-primary button-instrument-tienda logo-button-shopp" id="button-instrument-tienda" id="${id}" onclick="btnCarrito(${id})">Agregar al carrito <img src="./../assets/img/shopping.svg" alt="logo-shopping"></a>
          </div>
      </div>`;
